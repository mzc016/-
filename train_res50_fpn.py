...
def main(args):
    ...
    # check voc root  原来是VOCdevkit  我这里的数据集就成了吊臂数据集  arm_datasets了
    if os.path.exists(os.path.join(VOC_root, "arm_datasets")) is False:
        raise FileNotFoundError("arm_datasets dose not in path:'{}'.".format(VOC_root))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # coco_info = utils.evaluate(model, val_data_set_loader, device=device)  # 这里是验证
